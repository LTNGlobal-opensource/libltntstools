 ...
 * @param[in]   int buffer_min - Initial size of ring buffer for processing/detecting pes. Set to -1 to use the default of 4 * 1048576
 * @param[in]   int buffer_max - Maximum size of ring buffer. Set to -1 to use the default of 32 * 1048576

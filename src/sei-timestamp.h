...
/* This code was lifted from the LTN encoder project and thus pulled
 * into a single shared library for use across multiple products.
 * This is now considered the definitive material and the ltn encoder
 * references will be eventually removed.
 * TODO: remove ltn encoder older version
 */
